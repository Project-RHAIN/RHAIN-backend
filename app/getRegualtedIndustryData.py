...
def get_regulated_industries_data(state_name, county_name):
    print("Reading", state_name, county_name)
    selected_df = clinical_data_excel[["State","County","% Smokers","% Excessive Drinking","% Driving Deaths with Alcohol Involvement"]]
